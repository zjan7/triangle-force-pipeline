...
LOWER_ORANGE = (5, 100, 80) #hiermee heb je een oranje threshold, als er teveel noise is: verhoog S of V of verlaag H, als de driehoek niet gedetecteerd wordt: verlaag S en V of verhoog H.
UPPER_ORANGE = (22, 255, 255) 

SAMPLE_ID = 1
if __name__ == "__main__": #hiermee run je de pipeline, hier moet niets aangepast in worden
