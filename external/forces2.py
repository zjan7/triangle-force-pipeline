...
class ForceGenerator2:
    """
    Random force-map generator.

    This class keeps the same interface as the previous ForceGenerator2, so the
    rest of the pipeline does not need to change.

    __call__(x, y) returns:
        normal_force_density, shear_x_force_density, shear_y_force_density

    Units:
        normal_force_density: N/m^2
        shear_x_force_density: N/m^2
        shear_y_force_density: N/m^2

    The deformation generator later multiplies these values by triangle area,
    giving force values per triangle.
    """
